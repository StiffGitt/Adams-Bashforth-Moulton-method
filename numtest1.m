...
%
% Test badający rząd funkcji przy wyłączonym korektorze.
...
test2_func(Fx,Y0x,Sx,N1,Fxstr,Y0str,false,true)
test2_func(Fx,Y0x,Sx,N1,Fxstr,Y0str,false,false)
pause;
test2_func(Fx,Y0x,Sx,N2,Fxstr,Y0str,false,true)
test2_func(Fx,Y0x,Sx,N2,Fxstr,Y0str,false,false)
%Nowa funkcje
Sx = cell(4,1);
Fx = cell(4,1);
Y0x = cell(4,1);
...
Ystr = ["y(0) = 1","y(0) = 1, y'(0) = 1","y(0) = 1, y'(0) = 1, y''(0) = 1", ...
    "y(0) = 1, y'(0) = 1, y''(0) = 1, y'''(0) = 1"];

for i = 1:4
    pause;
    test2_func(Fx{i},Y0x{i},Sx{i},N1,Fstr(i),Ystr(i),false,true)
    test2_func(Fx{i},Y0x{i},Sx{i},N1,Fstr(i),Ystr(i),false,false)
end
end
